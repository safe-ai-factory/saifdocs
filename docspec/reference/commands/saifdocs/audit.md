...
Gap check: compares every page declared in `docspec/` against files on disk under `output-dir`. Reports missing references, concepts, how-to's, tutorials, landing pages, and unknown prereq concepts. Exits 1 if any gaps exist.
